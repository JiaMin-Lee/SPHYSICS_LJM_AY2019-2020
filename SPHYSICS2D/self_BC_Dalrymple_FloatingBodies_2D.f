...
599             format(a8,2(1x,i7),i3,2(1x,i2),2(1x,f12.6))            
     ...
     &                       -pm(j)*p_v*frxi,-pm(j)*p_v*frzi
                ...
                if(i.eq.890.and.j.ge.605.and.j.le.608) then
                  write(80,*) 'Include pressure gradient contribution'
                  write(80,*) 'Fluid particle, i = ', i
                  write(80,*) 'Floating body, j = ', j
                  write(80,*) 'DeltaP in x dir = -', pm(j)*p_v*frxi
                  write(80,*) 'DeltaP in z dir = -', pm(j)*p_v*frzi
                  write(80,*) 'ax(i) = ',ax(i),' az(i) = ',az(i)  
                end if
...
!                if(i.eq.605.and.j.ge.892.and.j.le.1327) then
!                  write(80,*) 'Include pressure gradient contribution'
!                  write(80,*) 'Floating body, i = ', i
!                  write(80,*) 'Fluid particle, j = ', j
!                 write(80,*) 'DeltaP in x dir = -',pm(j)*p_v*frxi*pm(i)
!                 write(80,*) 'DeltaP in z dir = -',pm(j)*p_v*frzi*pm(i)
!                end if
     ...
     &                        pm(i)*p_v*frxj, pm(i)*p_v*frzj
                ...
                if(j.eq.890.and.i.ge.605.and.i.le.608) then
                  write(80,*) 'Include pressure gradient contribution'
                  write(80,*) 'Fluid particle, j = ', j
                  write(80,*) 'Floating body, i = ', i
                  write(80,*) 'DeltaP in x dir = ', pm(i)*p_v*frxi
                  write(80,*) 'DeltaP in z dir = ', pm(i)*p_v*frzi
                  write(80,*) 'ax(j) = ',ax(j),' az(j) = ',az(j)
                end if
...
!                 if(j.eq.605.and.i.ge.892.and.i.le.1327) then
!                   write(80,*) 'Include pressure gradient contribution'
!                   write(80,*) 'Floating body, j = ', j
!                   write(80,*) 'Fluid particle, i = ', i
!                  write(80,*) 'DeltaP in x dir = ',pm(i)*p_v*frxi*pm(j)
!                  write(80,*) 'DeltaP in z dir = ',pm(i)*p_v*frzi*pm(j)
!                 end if
...
!               xsphz = -duz*pmj_Wab_over_rhobar
            ...
            else if (j.eq.890.and.i.ge.605.and.i.le.608) then

              write(80,*) '  '
              write(80,*) 'Summation of XSPH variant particle j = ',j
              write(80,*) 'Floating body, i = ',i
              write(80,*) 'XSPH in x dir = -',dux*pmi_Wab_over_rhobar
              write(80,*) 'XSPH in z dir = -',duz*pmi_Wab_over_rhobar
              write(80,*) 'ux(i)  = ', ux(j)            !have not multiply by epsilon = 0.5
              write(80,*) 'wx(i)  = ', wx(j)            !have not multiply by epsilon = 0.5
              write(80,*) '  '
